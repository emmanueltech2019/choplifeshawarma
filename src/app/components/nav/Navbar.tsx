    ...
    <div>
      <section className='fixed top-0 w-full px-4 pt-2 z-40 bg-[#fff]'>
        <div className='md:w-5/6 m-auto flex justify-between items-center'>
          ...
          <nav className={toggle ? 'absolute right-4 top-[80px] p-6 w-[301px] h-[530.01px] bg-[#fff] shadow-md rounded-3xl flex flex-col items-center transition-all ease-in-out duration-500 z-50' : 'absolute lg:static -right-[100%] top-[80px] p-6 lg:p-0 w-[301px] lg:w-full h-[530.01px] lg:h-auto bg-[#fff] lg:bg-none shadow-md lg:shadow-none rounded-3xl flex flex-col flex-[2] items-center lg:items-end transition-all ease-in-out duration-500 z-50'}>

            <ul className='lg:flex gap-9 text-[16px] text-[#6D6D6D] font-[400] leading-[50px] text-right my-5 lg:my-0'>
              <li className='hover:text-[#D00000] cursor-pointer transition duration-500 ease-in-out'>Home</li>
              <li className='hover:text-[#D00000] cursor-pointer transition duration-500 ease-in-out'>Menu</li>
              <li className='hover:text-[#D00000] cursor-pointer transition duration-500 ease-in-out'>About Us</li>
              <li className='hover:text-[#D00000] cursor-pointer transition duration-500 ease-in-out'>FAQ</li>
