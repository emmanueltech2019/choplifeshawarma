...
import { SpicyCarousel } from './CarouselObj';


const SpicyShawarma: React.FC = () => {
    ...
    <div>
      <div className="embla__viewport" ref={emblaRef}>
        <div className="embla__container">
          {
            SpicyCarousel.map((item: any) => (
              <div className="embla__slide" key={item.id}>
                <div className='bg-[#EB680A] h-[108px] rounded-[13px]'>
                  {item.image}
                </div>
