    ...
    <div>
      <section className=' fixed w-full px-4 pt-2 z-40 bg-[#fff] md:bg-transparent'>
        <div className='md:max-w-[80%] m-auto flex justify-between items-center'>
          ...
          <nav className={toggle ? 'absolute right-4 top-[80px] p-6 w-[301px] h-[530.01px] bg-[#fff] shadow-md rounded-3xl flex flex-col items-center transition-all ease-in-out duration-500 z-50' : 'absolute lg:static -right-[100%] top-[80px] p-6 lg:p-0 w-[301px] lg:w-full h-[530.01px] lg:h-auto bg-[#fff] lg:bg-none shadow-md lg:shadow-none rounded-3xl flex flex-col items-center lg:items-end transition-all ease-in-out duration-500 z-50'}>

            <ul className='lg:flex gap-9 text-[16px] text-[#6D6D6D] font-[400] leading-[50px] text-right my-5 lg:my-0'>
              <li className='cursor-pointer flex items-center gap-3 lg:gap-6 '><Icon icon="dashicons:lock" className='text-[20px] '></Icon>Home</li>
              <li>Menu</li>
              <li>About Us</li>
              <li>FAQ</li>
              <li className='hidden lg:block '><button className='text-[#fff] bg-[#D00000] px-[10px] rounded-[20px] shadow-md shadow-[#00000062]'>Contact Us</button></li>
            </ul>
